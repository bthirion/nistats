...
* New example showcasing the use of a GLM to get beta maps for decoding experiments (aka beta-regression) in :func:`examples/05_complete_examples/plot_haxby_block_classification.py`
